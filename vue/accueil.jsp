...
<body>
    <header>
        ...
        <nav>
            ...
            <% } %>
            <span>
                <%= fanfaron.getPrenom() %> <%= fanfaron.getNom() %>
                <% if (fanfaron.getAdmin()) { %>
    ...
    <main class="container">
        <section class="card">
            ...
            <div class="user-info">
                <p><strong>Nom de fanfaron :</strong> <%= fanfaron.getNomFanfaron() %></p>
                <p><strong>Email :</strong> <%= fanfaron.getEmail() %></p>
                <p><strong>Prénom :</strong> <%= fanfaron.getPrenom() %></p>
                <p><strong>Nom :</strong> <%= fanfaron.getNom() %></p>
                <p><strong>Genre :</strong> <%= fanfaron.getGenre() %></p>
                <p><strong>Contraintes alimentaires :</strong> <%= fanfaron.getContraintesAlimentaires() %></p>
                <p><strong>Administrateur :</strong> <%= fanfaron.getAdmin() ? "Oui" : "Non" %></p>
                <p><strong>Membre depuis :</strong> <%= fanfaron.getDateCreation() %></p>
            </div>
        </section>
    </main>
</body>
